    ...
    try:
        ...
        if current_ip != ip_address:
            ...
            elbv2_client.register_targets(
                ...
                Targets=[{"Id": ip_address, "Port": rds_port}],
            )
            message = (
            ...
            message = (
                ...
                f" IP: {ip_address} and Port: {rds_port}"
            )
        ...
        return {
            "success": False,
            "message": f"Failed to update targets for {rds_identifier} with error: {e}",
        }
...
def lambda_handler(event, context):
    ...
    return {"statusCode": status_code, "body": json.dumps(update_messages)}
